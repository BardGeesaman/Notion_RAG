...
PAGE_REGISTRY = {
    ...
    "Biophysical Assays": ("scripts.dashboard.pages.biophysical_assays", "render_biophysical_assays_page"),
...
PAGE_GROUPS = {
    ...
    "Analysis": ["Analysis Tools", "Experiment Planner", "RAG Query", "Statistical Analysis", "Quality Checks", "Literature Analysis", "Compare", "Timeline", "Data Quality", "Coverage Map", "Feature Recurrence", "Evidence Report", "Image Analysis", "Flow Cytometry", "Biophysical Assays"],
