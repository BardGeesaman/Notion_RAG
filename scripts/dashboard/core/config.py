...
PAGE_REGISTRY = {
    ...
    "Report Builder": ("scripts.dashboard.pages.report_builder", "main"),
    ...
    "Alignments": ("scripts.dashboard.pages.alignments", "render_alignments_page"),
    ...
    "Network Hub": ("scripts.dashboard.pages.network_hub", "render_network_hub_page"),
...
PAGE_GROUPS = {
    ...
    "Chemistry": ["Chemistry", "Chemical Sketcher", "Target Management", "Generative Chemistry", "Compound Portfolio", "ADMET Predictor", "GNN Toxicity", "Structural Alerts", "Compound Ranking", "Compound-Target Network", "SAR What-If", "Candidate Selection", "Retrosynthesis Advisor", "Compound Inventory", "Report Builder"],
    ...
    "ML/Predictive": ["Target QSAR", "MOA Inference", "Predictors", "Scoring", "Phenotypes", "Model Monitoring", "Model Registry", "AutoML Templates", "Experiment Optimizer", "Active Learning"],
    "Visualization": ["Projector", "Network Hub", "Pathway Map Viewer", "Visualizations", "Cytoscape Demo", "Entity Explorer", "Data Grid", "Genome Browser"],
