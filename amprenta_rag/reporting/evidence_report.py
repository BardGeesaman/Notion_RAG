...
def generate_program_evidence_report(
    ...
    try:
        from amprenta_rag.query.cross_omics.helpers import fetch_notion_page, extract_text_property
    ...
    metadata = {}
    try:
        from amprenta_rag.query.cross_omics.helpers import fetch_notion_page, extract_select_values
        page = fetch_notion_page(program_page_id)
...
def generate_dataset_evidence_report(
    ...
    try:
        ...
        dataset_name = extract_text_property(page, "Experiment Name") or extract_text_property(page, "Name") or dataset_name
    except Exception as e:
