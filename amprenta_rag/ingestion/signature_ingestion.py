...
def _find_or_create_signature_page(
    ...
    try:
        ...
        if results:
            ...
            _update_signature_page_if_needed(page_id, signature, signature_type, data_ownership, version, description, short_id)
            return page_id
...
def _find_or_create_lipid_species_page(
    ...
    if not hasattr(cfg.notion, 'lipid_species_db_id') or not cfg.notion.lipid_species_db_id:
        logger.warning(
