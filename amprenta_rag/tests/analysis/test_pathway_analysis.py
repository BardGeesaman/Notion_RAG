...
def test_map_features_to_kegg_pathways_parses(monkeypatch):
    ...
    monkeypatch.setattr(pa, "requests", type("R", (), {"get": lambda *a, **k: FakeResp("path:hsa00010\thsa:1", 200)})())
    monkeypatch.setattr(pa, "time", type("T", (), {"sleep": lambda s: None})())
...
def test_map_features_to_reactome_pathways_parses(monkeypatch):
    ...
    monkeypatch.setattr(pa, "requests", type("R", (), {"get": fake_get})())
