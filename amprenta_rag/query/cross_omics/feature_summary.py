...
def cross_omics_feature_summary(
    ...
    """
    Summarize all multi-omics evidence for a single feature (Postgres).
    """
    logger.info(
    ...
    return cross_omics_feature_summary_postgres(
...
"""
Cross-omics feature summary generation.

Generates multi-omics summaries for individual features (genes, proteins,
metabolites, lipids) by aggregating evidence across all omics modalities.
"""
