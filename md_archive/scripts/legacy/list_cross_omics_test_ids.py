...
def main():
    ...
    print("  python test_cross_omics.py --program <program_id_from_above>")
    print()
    print("  # Test with a signature:")
    print("  python test_cross_omics.py --signature <signature_id_from_above>")
    print()
    print("  # Test with a dataset:")
    print("  python test_cross_omics.py --dataset <dataset_id_from_above>")
    print()
    print("  # Test with a feature:")
    print("  python test_cross_omics.py --feature 'metabolite:<feature_name_from_above>'")
    print()
