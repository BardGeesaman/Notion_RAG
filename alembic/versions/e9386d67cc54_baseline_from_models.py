"""baseline_from_models

Revision ID: e9386d67cc54
Revises: 
Create Date: 2025-12-27 19:07:04.869610
...
def upgrade() -> None:
    ...
    op.create_table('pinned_dashboards',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('notebook_path', sa.String(length=500), nullable=False),
    sa.Column('program_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_pinned_dashboards_notebook_path'), 'pinned_dashboards', ['notebook_path'], unique=False)
    op.create_index(op.f('ix_pinned_dashboards_pinned_by_id'), 'pinned_dashboards', ['pinned_by_id'], unique=False)
    op.create_index(op.f('ix_pinned_dashboards_program_id'), 'pinned_dashboards', ['program_id'], unique=False)
    ...
    op.add_column('datasets', sa.Column('dvc_pushed', sa.Boolean(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_pinned_dashboards_program_id'), table_name='pinned_dashboards')
    op.drop_index(op.f('ix_pinned_dashboards_pinned_by_id'), table_name='pinned_dashboards')
    op.drop_index(op.f('ix_pinned_dashboards_notebook_path'), table_name='pinned_dashboards')
